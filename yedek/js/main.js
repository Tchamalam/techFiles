...
jQuery(document).on('ready', function() {
	...
	_tg_upcomingeventcounter.countdown('2018/08/02', function(event) {
		var $this = jQuery(this).html(event.strftime(''
			+ '<div class="tg-eventcounter"><span>%-D</span><span> Gün</span></div>'
			+ '<div class="tg-eventcounter"><span>%H</span><span>Saat</span></div>'
			+ '<div class="tg-eventcounter"><span>%M</span><span>Dakika</span></div>'
			+ '<div class="tg-eventcounter"><span>%S</span><span>Saniye</span></div>'
		));
	});
	/* -------------------------------------
			NEXT EVENT COUNTER
	...
	_tg_upcomingeventcountervtwo.countdown('2018/12/12', function(event) {
		var $this = jQuery(this).html(event.strftime(''
			+ '<div class="tg-eventcounterholder"><div class="tg-eventcounter"><span>%-D</span><span> Gün</span></div></div>'
			+ '<div class="tg-eventcounterholder"><div class="tg-eventcounter"><span>%H</span><span>Saat</span></div></div>'
			+ '<div class="tg-eventcounterholder"><div class="tg-eventcounter"><span>%M</span><span>Dakika</span></div></div>'
			+ '<div class="tg-eventcounterholder"><div class="tg-eventcounter"><span>%S</span><span>Saniye</span></div></div>'
		));
	});
	/* -------------------------------------
			TESTIMONIAL SLIDER
