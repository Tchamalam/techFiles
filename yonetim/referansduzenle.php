		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="panel panel-default">
					...
					<h3 class="panel-title">Referans Düzenle</h3>
					...
					if(isset($_POST['gonder'])){
						...
						if($_FILES["dosya"]["size"] > 0){
							...
							$duyuru = mysql_fetch_assoc(mysql_query("SELECT * FROM referanslar WHERE id='$id'"));
							...
							if ($yukle){
								...
								$resim = mysql_query("SELECT * FROM referanslar WHERE id='$id'");
								...
								$guncelle = mysql_query("UPDATE referanslar SET baslik='$baslik', baslikseo='$baslikseo', katid='$katid', resim='$yeniresimadi', yazi='$yazi', public='$public' WHERE id='$id' and dil='".$diller->id."'");
								}
							...
							$yazi = $_POST["yazi".$diller->links];
							$yazi=str_replace("'", "`", $yazi);
							$guncelle = mysql_query("UPDATE referanslar SET baslik='$baslik', baslikseo='$baslikseo', katid='$katid', yazi='$yazi', public='$public' WHERE id='$id' and dil='".$diller->id."'");
							}
							if($guncelle){
					...
					$gelen = mysql_fetch_assoc(mysql_query("SELECT * FROM referanslar WHERE id='$id'"));
					...
					<form class="form-horizontal" method="POST" action="<?php $PHP_SELF?>" enctype="multipart/form-data">
						...
						<?php if($gelen['resim'] != ""){ ?>
							...
							$j++;
							  $dyr_kyt=mysql_fetch_object(mysql_query("select * from referanslar where id='$id' and dil='".$diller2->id."'"));?>
							<div class="tab-pane fade <?php if($j==1){ echo "active"; } ?> in" id="<?php echo $diller2->links?>">
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="baslik<?php echo $diller2->links?>" placeholder="Referans Başlığı" value="<?php echo $dyr_kyt->baslik?>">
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-lg-12">
											<button name="gonder" type="submit" class="btn btn-default">Referans Düzenle</button>
										</div>
									</div>
					...
					if($resimid > 0){
						...
						$resim = mysql_query("SELECT * FROM referansresimler WHERE id='$resimid'");
						...
						$sil = mysql_query("DELETE FROM referansresimler WHERE id='$resimid'");
					...
					<div class="row">
				    	...
				    	$rs = mysql_query("SELECT * FROM referansresimler WHERE resid='$id' ORDER BY ordernum ASC");
				        ...
				        <div class="col-xs-3" id="listItem_<?php echo $rs_getir['id']; ?>">
				            ...
				            <center><a href="referansduzenle.php?id=<?php echo $id?>&resimid=<?php echo $rs_getir['id']?>"><span class="glyphicon glyphicon-remove"></span></a></center>
		...
		$(function() {
		  ...
		  $("#test-list").sortable({
		    ...
		    update:function(){
		      ...
		      $.post("referansresimsiralaislem.php",posted,function(e){
