			...
			<div class="col-md-9">
				...
				<div class="panel panel-default">
					...
					if(isset($_POST['gonder'])){
						...
						$son_id=mysql_fetch_object(mysql_query("select * from musteriler order by ids desc"));
						$idal=$son_id->id;
						$idal=$idal+1;
						...
						$left   = $_POST["left"];
						$top   = $_POST["top"];
						$sor = mysql_query("SELECT * FROM musteriler WHERE baslik='$baslik'");
						if(mysql_num_rows($sor) > 0){
							...
							if($baslik == ""){
								...
								if($_FILES["dosya"]["size"] > 0){
									...
									$ekle =  mysql_query("INSERT INTO musteriler (id, baslik, baslikseo, lefts, top, resim, yazi, tarih, public, dil) VALUES ('$idal', '$baslik', '$baslikseo', '$left', '$top', '$yeniresimadi', '$yazi', '$tarih', '$public', '$diller->id')");
									}
									...
									$ekle2 = mysql_query("INSERT INTO musteriler (id, baslik, baslikseo, lefts, top, yazi, tarih, public, dil) VALUES ('$idal', '$baslik', '$baslikseo', '$left', '$top', '$yazi', '$tarih', '$public', '$diller->id')");
									}
					...
					<form class="form-horizontal" method="POST" action="<?php $PHP_SELF?>" enctype="multipart/form-data">
						...
						<div id="myTabContent" class="tab-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                <input type="text" class="form-control" id="inputEmail" name="left" placeholder="" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail" class="col-lg-2 control-label">Top Değeri</label>
                                <div class="col-lg-10">
                                <input type="text" class="form-control" id="inputEmail" name="top" placeholder="" value="">
                                </div>
                            </div>
							...
							<div class="tab-pane <?php if($j==1){ echo "active"; } ?> fade in" id="<?php echo $diller2->links?>">
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="baslik<?php echo $diller2->links?>" placeholder="Kayıt Başlığı">
										</div>
									</div>
