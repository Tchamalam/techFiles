		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="panel panel-default">
					...
					<h3 class="panel-title">Yeni Etkinlik Ekle</h3>
					...
					if(isset($_POST['gonder'])){
						...
						$son_id=mysql_fetch_object(mysql_query("select * from etkinlik order by ids desc"));
						$idal=$son_id->id;
						$idal=$idal+1;
						$baslik   = $_POST["basliktr"];
						$sor = mysql_query("SELECT * FROM etkinlik WHERE baslik='$baslik'");
						if(mysql_num_rows($sor) > 0){

							echo '<div class="alert alert-danger">'.$baslik.' Adlı Etkinlik Sistemde Bulunmaktadır.</div>';
							...
							if($baslik == ""){
								...
								if($_FILES["dosya"]["size"] > 0){
									...
									if ($yukle){
										...
										$ekle =  mysql_query("INSERT INTO etkinlik (id, katid, baslik, baslikseo, resim, kisa_yazi, yazi, tarih, tarih2, dil, mekan, bsaat, csaat, ucret) VALUES ('$idal', '$kat', '$baslik', '$baslikseo', '$yeniresimadi', '$kisa_yazi', '$yazi', '$tarih', '$tarih2', '$diller->id', '$mekan', '$bsaat', '$csaat', '$ucret')");
										 }
									...
									$mekan = $_POST["mekan".$diller->links];
									$ucret = $_POST["ucret".$diller->links];
									$ekle2 = mysql_query("INSERT INTO etkinlik (id, katid, baslik, baslikseo, kisa_yazi, yazi, tarih, tarih2, dil, mekan, bsaat, csaat, ucret) VALUES ('$idal', '$kat', '$baslik', '$baslikseo', '$kisa_yazi', '$yazi', '$tarih', '$tarih2', '$diller->id', '$mekan', '$bsaat', '$csaat', '$ucret')");
									}
							...
							<div class="tab-pane <?php if($j==1){ echo "active"; } ?> fade in" id="<?php echo $diller2->links?>">
								<fieldset>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                        <input type="text" class="form-control" id="inputEmail" name="baslik<?php echo $diller2->links?>" placeholder="Etkinlik Başlığı">
                                        </div>
                                    </div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="bsaat<?php echo $diller2->links?>" placeholder="Başlangıç Saati" value="<?php echo $dyr_kyt->bsaat?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="csaat<?php echo $diller2->links?>" placeholder="Bitiş Saati">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="mekan<?php echo $diller2->links?>" placeholder="Etkinlik Mekanı">
										</div>
									</div>

									<div class="form-group">
										<label for="inputEmail" class="col-lg-2 control-label">Ücret</label>
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="ucret<?php echo $diller2->links?>" placeholder="Etkinlik Ücreti">
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-lg-12">
											<button name="gonder" type="submit" class="btn btn-default">Etkinlik Ekle</button>
										</div>
									</div>
