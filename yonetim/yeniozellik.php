		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="panel panel-default">
					...
					<h3 class="panel-title">Yeni Özellik Ekle</h3>
					...
					if(isset($_POST['gonder'])){
						$son_id=mysql_fetch_object(mysql_query("select * from ozellikler order by ids desc"));
						$idal=$son_id->id;
						$idal=$idal+1;
						...
						$yukle2 = move_uploaded_file($kaynak2,$a2);
								...
								if($_FILES["dosya"]["size"] > 0){
									...
									while($diller=mysql_fetch_object($sql_dil)){
										...
										$ekle =  mysql_query("INSERT INTO ozellikler (id, katid, baslik, baslikseo, resim, kisa_yazi, yazi, dil) VALUES ('$idal', '$kat', '$baslik', '$baslikseo', '$yeniresimadi', '$kisa_yazi', '$yazi', '$diller->id')");
									}
										if($ekle){
											echo '<div class="alert alert-success">Yeni Özellik Başarıyla Eklendi</div>';
									...
									while($diller=mysql_fetch_object($sql_dil)){
										...
										$description   = $_POST["description".$diller->links];
										$keywords   = $_POST["keywords".$diller->links];
									$ekle2 = mysql_query("INSERT INTO ozellikler (id, katid, baslik, baslikseo, kisa_yazi, yazi, dil) VALUES ('$idal', '$kat', '$baslik', '$baslikseo', '$kisa_yazi', '$yazi', '$diller->id')");
									}
									if($ekle2){
						...
						<div id="myTabContent" class="tab-content">
							...
							<div class="form-group">
								...
								<select name="kat" class="form-control">
									...
									?>
									<option value="<?php echo $kyaz2['id'];?>">&nbsp;&nbsp;&nbsp;<?php echo $kyaz2['baslik'];?></option>
									<? endwhile;endwhile; ?>
								</select>
								</div>
							</div>
							...
							<div class="tab-pane <?php if($j==1){ echo "active"; } ?> fade in" id="<?php echo $diller2->links?>">
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="baslik<?php echo $diller2->links?>" placeholder="Özellik Başlığı">
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-lg-12">
											<button name="gonder" type="submit" class="btn btn-default">Özellik Ekle</button>
										</div>
									</div>
