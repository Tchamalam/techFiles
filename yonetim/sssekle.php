		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="panel panel-default">
					...
					<h3 class="panel-title">Yeni Satış Noktası Ekle</h3>
					...
					if(isset($_POST['gonder'])){
						...
						$son_id=mysql_fetch_object(mysql_query("select * from sss order by ids desc"));
						$idal=$son_id->id;
						$idal=$idal+1;
						$baslik   = $_POST["basliktr"];
						$katid   = $_POST["katid"];
						$sor = mysql_query("SELECT * FROM sss WHERE baslik='$baslik'");
							...
							echo '<div class="alert alert-danger">'.$baslik.' Adlı Kayıt Sistemde Bulunmaktadır.</div>';
								...
								if($_FILES["dosya"]["size"] > 0){
									...
									if ($yukle){
										...
										$ekle =  mysql_query("INSERT INTO sss (id, baslik, baslikseo, resim, katid, kisa_yazi, yazi, tarih, dil) VALUES ('$idal', '$baslik', '$baslikseo', '$yeniresimadi', '$katid', '$kisa_yazi', '$yazi', '$tarih', '$diller->id')");
										 }
									...
									$yazi 	  = $_POST["yazi".$diller->links];
									$yazi=str_replace("'", "`", $yazi);
									$ekle2 = mysql_query("INSERT INTO sss (id, baslik, baslikseo, kisa_yazi, yazi, katid, tarih,dil) VALUES ('$idal', '$baslik', '$baslikseo', '$kisa_yazi', '$yazi', '$katid', '$tarih', '$diller->id')");
									}
						...
						<div id="myTabContent" class="tab-content">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									...
									<?php
									$ust = mysql_query("SELECT * FROM sss WHERE katid='0' and dil='1' ORDER BY ordernum ASC");
							...
							<div class="tab-pane <?php if($j==1){ echo "active"; } ?> fade in" id="<?php echo $diller2->links?>">
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="firmaadi" name="baslik<?php echo $diller2->links?>" placeholder="Firma Adı">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="telefon" name="kisa_yazi<?php echo $diller2->links?>" placeholder="Telefon">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="adres" name="yazi<?php echo $diller2->links?>" placeholder="Adres">
										</div>
									</div>
