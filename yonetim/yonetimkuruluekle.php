			...
			<div class="col-md-9">
				...
				<div class="panel panel-default">
					...
					if(isset($_POST['gonder'])){
						...
						$son_id=mysql_fetch_object(mysql_query("select * from yonetimkurulu order by ids desc"));
						$idal=$son_id->id;
						$idal=$idal+1;
						$baslik   = $_POST["basliktr"];
						$sor = mysql_query("SELECT * FROM yonetimkurulu WHERE baslik='$baslik'");
							...
							if($baslik == ""){
								...
								if($_FILES["dosya"]["size"] > 0){
									...
									if ($yukle){
										...
										$ekle =  mysql_query("INSERT INTO yonetimkurulu (id, baslik, kisa_yazi, resim, yazi, tarih, dil) VALUES ('$idal', '$baslik', '$kisa_yazi', '$yeniresimadi', '$yazi', '$tarih', '$diller->id')");
										 }
									...
									$kisa_yazi 	  = $_POST["kisa_yazi".$diller->links];
									$kisa_yazi=str_replace("'", "`", $kisa_yazi);
									$ekle2 = mysql_query("INSERT INTO yonetimkurulu (id, baslik, kisa_yazi, yazi, tarih,dil) VALUES ('$idal', '$baslik', '$kisa_yazi', '$yazi', '$tarih', '$diller->id')");
									}
							...
							<div class="tab-pane <?php if($j==1){ echo "active"; } ?> fade in" id="<?php echo $diller2->links?>">
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="kisa_yazi<?php echo $diller2->links?>" placeholder="">
										</div>
									</div>
