		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="panel panel-default">
					...
					<h3 class="panel-title">Yeni Proje Ekle</h3>
					...
					if(isset($_POST['gonder'])){
						$son_id=mysql_fetch_object(mysql_query("select * from projeler order by ids desc"));
						$idal=$son_id->id;
						$idal=$idal+1;
						...
						$yukle2 = move_uploaded_file($kaynak2,$a2);
								...
								if($_FILES["dosya"]["size"] > 0){
									...
									while($diller=mysql_fetch_object($sql_dil)){
										...
										$kat = $_POST["kat"];
										$ekle =  mysql_query("INSERT INTO projeler (id, katid, hizmetid, baslik, issahibi, kesif, tarih, baslikseo, resim, yazi, dil) VALUES ('$idal', '$kat', '$hizmetid', '$baslik', '$issahibi', '$kesif', '$tarih', '$baslikseo', '$yeniresimadi', '$yazi', '$diller->id')");
									}
										if($ekle){
											echo '<div class="alert alert-success">Yeni Proje Başarıyla Eklendi</div>';
									...
									while($diller=mysql_fetch_object($sql_dil)){
										...
										$hizmetid = $_POST["hizmetid"];
										$kat = $_POST["kat"];
									$ekle2 = mysql_query("INSERT INTO projeler (id, katid, hizmetid, baslik, issahibi, kesif, tarih, baslikseo, yazi, dil) VALUES ('$idal', '$kat', '$hizmetid', '$baslik', '$issahibi',  '$kesif',  '$tarih', '$baslikseo', '$yazi', '$diller->id')");
									}
									if($ekle2){
						...
						<div id="myTabContent" class="tab-content">
							...
							<div class="form-group">
								...
								<select name="hizmetid" class="form-control">
									...
									?>
									<option value="<?php echo $hizmetkat['id'];?>"><?php echo $hizmetkat['baslik'];?></option>
							...
							<div class="tab-pane <?php if($j==1){ echo "active"; } ?> fade in" id="<?php echo $diller2->links?>">
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="baslik<?php echo $diller2->links?>" placeholder="Proje Başlığı">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="issahibi<?php echo $diller2->links?>" placeholder="Bölge">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="tarih<?php echo $diller2->links?>" placeholder="Tarih">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="kesif<?php echo $diller2->links?>" placeholder="Yüzölçümü">
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-lg-12">
											<button name="gonder" type="submit" class="btn btn-default">Proje Ekle</button>
										</div>
									</div>
