		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="panel panel-default">
					...
					<h3 class="panel-title">Yeni Galeri Ekle</h3>
					...
					if(isset($_POST['gonder'])){
						...
						$son_id=mysql_fetch_object(mysql_query("select * from galeri order by ids desc"));
						$idal=$son_id->id;
						$idal=$idal+1;
						$baslik   = $_POST["basliktr"];
						$sor = mysql_query("SELECT * FROM galeri WHERE baslik='$baslik'");
							...
							if($baslik == ""){
								...
								if($_FILES["dosya"]["size"] > 0){
									...
									if ($yukle){
										...
										$yazi=str_replace('"', '&quot;', $yazi);
										$ekle =  mysql_query("INSERT INTO galeri (id, baslik, baslikseo, kisa_yazi, resim, yazi, tarih, dil) VALUES ('$idal', '$baslik', '$baslikseo', '$kisa_yazi', '$yeniresimadi', '$yazi', '$tarih', '$diller->id')");
										 }
									...
									$yazi=str_replace("'", "`", $yazi);
									$yazi=str_replace('"', '&quot;', $yazi);
									$ekle2 = mysql_query("INSERT INTO galeri (id, baslik, baslikseo, kisa_yazi, yazi, tarih,dil) VALUES ('$idal', '$baslik', '$baslikseo', '$kisa_yazi', '$yazi', '$tarih', '$diller->id')");
									}
							...
							<div class="tab-pane <?php if($j==1){ echo "active"; } ?> fade in" id="<?php echo $diller2->links?>">
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="kisa_yazi<?php echo $diller2->links?>" placeholder="Açıklama">
										</div>
									</div>
                                    
									<div class="form-group">
										<div class="col-lg-12">
											<button name="gonder" type="submit" class="btn btn-default">Ekle</button>
										</div>
									</div>
