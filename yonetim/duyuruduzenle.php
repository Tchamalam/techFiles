				...
				<div class="panel panel-default">
					...
					if(isset($_POST['gonder'])){
						...
						if($_FILES["dosya"]["size"] > 0){
							...
							$duyuru = mysql_fetch_assoc(mysql_query("SELECT * FROM duyurular WHERE id='$id'"));
							...
							if ($yukle){
								...
								$resim = mysql_query("SELECT * FROM duyurular WHERE id='$id'");
								...
								$sqlsay=mysql_num_rows(mysql_query("select * from duyurular where baslikseo='".$baslikseo."' and dil='".$_SESSION["dil"]."'"));
								if ($sqlsay>1)
								{
								...
								$guncelle = mysql_query("UPDATE duyurular SET baslik='$baslik', baslikseo='$baslikseo', katid='$katid', resim='$yeniresimadi', yazi='$yazi', public='$public' WHERE id='$id' and dil='".$diller->id."'");
								}
								echo '<div class="alert alert-success">Seçilen Haber Başarıyla Düzenlendi..</div>';
							...
							$yazi = $_POST["yazi".$diller->links];
							$yazi=str_replace("'", "`", $yazi);
							$guncelle = mysql_query("UPDATE duyurular SET baslik='$baslik', baslikseo='$baslikseo', katid='$katid', yazi='$yazi', public='$public' WHERE id='$id' and dil='".$diller->id."'");
							}
							if($guncelle){
					...
					$gelen = mysql_fetch_assoc(mysql_query("SELECT * FROM duyurular WHERE id='$id'"));
						...
						<?php if($gelen['resim'] != ""){ ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <?php
                                    $ust = mysql_query("SELECT * FROM duyurular WHERE dil='1' ORDER BY ordernum ASC");
							...
							$j++;
							  $dyr_kyt=mysql_fetch_object(mysql_query("select * from duyurular where id='$id' and dil='".$diller2->id."'"));?>
							<div class="tab-pane fade <?php if($j==1){ echo "active"; } ?> in" id="<?php echo $diller2->links?>">
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="baslik<?php echo $diller2->links?>" placeholder="Haber Başlığı" value="<?php echo $dyr_kyt->baslik?>">
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-lg-12">
											<button name="gonder" type="submit" class="btn btn-default">Haber Düzenle</button>
										</div>
									</div>
					...
					if($resimid > 0){
						...
						$resim = mysql_query("SELECT * FROM duyururesimler WHERE id='$resimid'");
						...
						$sil = mysql_query("DELETE FROM duyururesimler WHERE id='$resimid'");
					...
					<div class="row">
				    	...
				    	$rs = mysql_query("SELECT * FROM duyururesimler WHERE resid='$id' ORDER BY ordernum ASC");
				        ...
				        <div class="col-xs-3" id="listItem_<?php echo $rs_getir['id']; ?>">
				            ...
				            <center><a href="duyuruduzenle.php?id=<?php echo $id?>&resimid=<?php echo $rs_getir['id']?>"><span class="glyphicon glyphicon-remove"></span></a></center>
		...
		$(function() {
		  ...
		  $("#test-list").sortable({
		    ...
		    update:function(){
		      ...
		      $.post("duyururesimsiralaislem.php",posted,function(e){
