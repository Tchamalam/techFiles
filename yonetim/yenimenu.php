		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="panel panel-default">
					...
					<h3 class="panel-title">Yeni Menü Ekle</h3>
					...
					if(isset($_POST['gonder'])){
						...
						$sor = mysql_query("SELECT * FROM menuler WHERE baslik='$baslik'");

						if(mysql_num_rows($sor) > 0){

							echo '<div class="alert alert-danger">'.$baslik.' Adlı Menü Sistemde Bulunmaktadır.</div>';
							...
							if($baslik == ""){
								...
								if($_FILES["dosya"]["size"] > 0){
									...
									if ($yukle){
										...
										$ekle =  mysql_query("INSERT INTO menuler (katid, public, baslik, basliken, resim, kisa_yazi, kisa_yazien, yazi, yazien) VALUES ('$kat', '$public', '$baslik', '$basliken', '$yeniresimadi', '$kisa_yazi', '$kisa_yazien', '$yazi', '$yazien')");
										
										if($ekle){
											echo '<div class="alert alert-success">Yeni Menü Başarıyla Eklendi</div>';
									...
									$ekle2 = mysql_query("INSERT INTO menuler (katid, public, baslik, basliken, kisa_yazi, kisa_yazien, yazi, yazien) VALUES ('$kat', '$public', '$baslik', '$basliken', '$kisa_yazi', '$kisa_yazien', '$yazi', '$yazien')");
							...
							<div class="tab-pane fade active in" id="tr">
								...
								<fieldset>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										Göster <input type="radio" name="public" value="1" />
										Gösterme <input type="radio" name="public" value="0" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="baslik" placeholder="Haber Başlığı">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
										<textarea name="kisa_yazi" class="form-control" placeholder="Kısa Yazı"></textarea>
										</div>
									</div>

									<div class="form-group">
										<div class="col-lg-12">
										<textarea name="yazi" id="editor1" placeholder="Açıklama"></textarea>
										</div>
									</div>

									<div class="form-group">
										<div class="col-lg-12">
											<button name="gonder" type="submit" class="btn btn-default">Menü Ekle</button>
										</div>
									</div>
							...
							<div class="tab-pane fade in" id="en">
								...
								<fieldset>
									...
									<div class="form-group">
										<label for="inputEmail" class="col-lg-2 control-label">Başlık</label>
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="basliken" placeholder="Haber Başlığı">
										</div>
									</div>
									...
									<div class="form-group">
										<label for="inputEmail" class="col-lg-2 control-label">Kısa Yazı</label>
										<div class="col-lg-10">
										<textarea name="kisa_yazien" class="form-control" placeholder="Kısa Yazı"></textarea>
										</div>
									</div>

									<div class="form-group">
										<div class="col-lg-12">
										<textarea name="yazien" id="editor2" placeholder="Açıklama"></textarea>
										</div>
									</div>
