		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="panel panel-default">
					...
					<h3 class="panel-title"> Satış Noktası Düzenle</h3>
					...
					if(isset($_POST['gonder'])){
						...
						if($_FILES["dosya"]["size"] > 0){
							...
							$sss = mysql_fetch_assoc(mysql_query("SELECT * FROM sss WHERE id='$id'"));
							$sss_adi = $sss["resim"];
							...
							if ($yukle){
								...
								$resim = mysql_query("SELECT * FROM sss WHERE id='$id'");
								...
								$sqlsay=mysql_num_rows(mysql_query("select * from sss where baslikseo='".$baslikseo."' and dil='".$_SESSION["dil"]."'"));
								if ($sqlsay>1)
								{
								...
								$guncelle = mysql_query("UPDATE sss SET baslik='$baslik', baslikseo='$baslikseo', resim='$yeniresimadi', katid='$katid', kisa_yazi='$kisa_yazi', yazi='$yazi' WHERE id='$id' and dil='".$diller->id."'");
								}
							...
							$yazi = $_POST["yazi".$diller->links];
							$yazi=str_replace("'", "`", $yazi);
							$guncelle = mysql_query("UPDATE sss SET baslik='$baslik', baslikseo='$baslikseo', kisa_yazi='$kisa_yazi', yazi='$yazi', katid='$katid' WHERE id='$id' and dil='".$diller->id."'");
							}
							if($guncelle){
					...
					$gelen = mysql_fetch_assoc(mysql_query("SELECT * FROM sss WHERE id='$id'"));
						...
						<div id="myTabContent" class="tab-content">
                            ...
                            <div class="form-group">
                                ...
                                <select name="kat" class="form-control">
                                    ...
                                    <?php
                                        $kategori = mysql_query("select * from sss where katid='0' and dil='1' order by ordernum asc");
							...
							$j++;
							  $dyr_kyt=mysql_fetch_object(mysql_query("select * from sss where id='$id' and dil='".$diller2->id."'"));?>
							<div class="tab-pane fade <?php if($j==1){ echo "active"; } ?> in" id="<?php echo $diller2->links?>">
								
								<fieldset>
									<div class="form-group">
										<label for="firmaadi" class="col-lg-2 control-label">Firma Adı</label>
										<div class="col-lg-10">
										<input type="text" class="form-control" id="firmaadi" name="baslik<?php echo $diller2->links?>" placeholder="Firma Adı" value="<?php echo $dyr_kyt->baslik?>">
										</div>
									</div>

									<div class="form-group">
										<label for="telefon" class="col-lg-2 control-label">Telefon</label>
										<div class="col-lg-10">
										<input type="text" class="form-control" id="telefon" name="kisa_yazi<?php echo $diller2->links?>" placeholder="Telefon" value="<?php echo $dyr_kyt->kisa_yazi?>">
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-12">
										<input type="text" class="form-control" id="adres" name="yazi<?php echo $diller2->links?>" placeholder="Adres" value="<?php echo $dyr_kyt->yazi?>">
										</div>
									</div>
					...
					if($resimid > 0){
						...
						$resim = mysql_query("SELECT * FROM sssresimler WHERE id='$resimid'");
						...
						$sil = mysql_query("DELETE FROM sssresimler WHERE id='$resimid'");
					...
					<div class="row">
				    	...
				    	$rs = mysql_query("SELECT * FROM sssresimler WHERE resid='$id' ORDER BY ordernum ASC");
				        ...
				        <div class="col-xs-3" id="listItem_<?php echo $rs_getir['id']; ?>">
				            ...
				            <center><a href="sssduzenle.php?id=<?php echo $id?>&resimid=<?php echo $rs_getir['id']?>"><span class="glyphicon glyphicon-remove"></span></a></center>
		...
		$(function() {
		  ...
		  $("#test-list").sortable({
		    ...
		    update:function(){
		      ...
		      $.post("sssresimsiralaislem.php",posted,function(e){
