		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="panel panel-default">
					...
					<h3 class="panel-title">Etkinlik Düzenle</h3>
					...
					if(isset($_POST['gonder'])){
						...
						if($_FILES["dosya"]["size"] > 0){
							...
							$durak = mysql_fetch_assoc(mysql_query("SELECT * FROM etkinlik WHERE id='$id'"));
							...
							if ($yukle){
								...
								$resim = mysql_query("SELECT * FROM etkinlik WHERE id='$id'");
								...
								$sqlsay=mysql_num_rows(mysql_query("select * from etkinlik where baslikseo='".$baslikseo."' and dil='".$_SESSION["dil"]."'"));
								if ($sqlsay>1)
								{
								...
								$tarih2 = $_POST["date".$diller->links];
								$bsaat = $_POST["bsaat"];
								$csaat = $_POST["csaat"];
								$mekan = $_POST["mekan"];
								$ucret = $_POST["ucret"];
								$guncelle = mysql_query("UPDATE etkinlik SET katid='$kat', baslik='$baslik', baslikseo='$baslikseo', resim='$yeniresimadi', kisa_yazi='$kisa_yazi', yazi='$yazi', tarih2='$tarih2', mekan='$mekan', bsaat='$bsaat', csaat='$csaat', ucret='$ucret' WHERE id='$id' and dil='".$diller->id."'");
								}
							...
							$kisa_yazi=str_replace("'", "`", $kisa_yazi);
							$tarih2 = $_POST["date".$diller->links];
							$bsaat = $_POST["bsaat".$diller->links];
							$csaat = $_POST["csaat".$diller->links];
							$mekan = $_POST["mekan".$diller->links];
							$ucret = $_POST["ucret".$diller->links];
							$guncelle = mysql_query("UPDATE etkinlik SET katid='$kat', baslik='$baslik', baslikseo='$baslikseo', yazi='$yazi', kisa_yazi='$kisa_yazi', tarih2='$tarih2', mekan='$mekan', bsaat='$bsaat', csaat='$csaat', ucret='$ucret' WHERE id='$id' and dil='".$diller->id."'");
							}
							if($guncelle){
					...
					$gelen = mysql_fetch_assoc(mysql_query("SELECT * FROM etkinlik WHERE id='$id'"));
						...
						<div id="myTabContent" class="tab-content">
                            ...
                            <div class="form-group">
                                ...
                                <select name="kat" class="form-control">
                                    ...
                                    <?php
                                        $kategori = mysql_query("select * from etkinlik where katid='0' and dil='1' order by ordernum asc");
							...
							$j++;
							  $dyr_kyt=mysql_fetch_object(mysql_query("select * from etkinlik where id='$id' and dil='".$diller2->id."'"));?>
							<div class="tab-pane fade <?php if($j==1){ echo "active"; } ?> in" id="<?php echo $diller2->links?>">
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
									<input type="text" class="form-control" id="inputEmail" name="baslik<?php echo $diller2->links?>" placeholder="Etkinlik Başlığı" value="<?php echo $dyr_kyt->baslik?>">
									</div>
								</div>								
								...
								<div class="form-group">
									...
									<div class="col-lg-10">
										<div class="input-group">
									        ...
									        <input class="form-control" id="date" name="date<?php echo $diller2->links?>" placeholder="YYYY-MM-DD" value="<?php echo $dyr_kyt->tarih2;?>" type="text"/>
									       </div>
									</div>
								</div>

								<div class="form-group">
									<label for="inputEmail" class="col-lg-2 control-label">Başlangıç Saati</label>
									<div class="col-lg-10">
									<input type="text" class="form-control" id="inputEmail" name="bsaat<?php echo $diller2->links?>" placeholder="Etkinlik Mekanı" value="<?php echo $dyr_kyt->bsaat?>">
									</div>
								</div>

								<div class="form-group">
									<label for="inputEmail" class="col-lg-2 control-label">Bitiş Saati</label>
									<div class="col-lg-10">
									<input type="text" class="form-control" id="inputEmail" name="csaat<?php echo $diller2->links?>" placeholder="Etkinlik Mekanı" value="<?php echo $dyr_kyt->csaat?>">
									</div>
								</div>

								<div class="form-group">
									<label for="inputEmail" class="col-lg-2 control-label">Mekan</label>
									<div class="col-lg-10">
									<input type="text" class="form-control" id="inputEmail" name="mekan<?php echo $diller2->links?>" placeholder="Etkinlik Mekanı" value="<?php echo $dyr_kyt->mekan?>">
									</div>
								</div>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        <button name="gonder" type="submit" class="btn btn-default">Etkinlik Düzenle</button>
                                    </div>
                                </div>
					...
					if($resimid > 0){
						...
						$resim = mysql_query("SELECT * FROM etkinlikresimler WHERE id='$resimid'");
						...
						$sil = mysql_query("DELETE FROM etkinlikresimler WHERE id='$resimid'");
					...
					<div class="row">
				    	...
				    	$rs = mysql_query("SELECT * FROM etkinlikresimler WHERE resid='$id' ORDER BY ordernum ASC");
				        ...
				        <div class="col-xs-3" id="listItem_<?php echo $rs_getir['id']; ?>">
				            ...
				            <center><a href="etkinlikduzenle.php?id=<?php echo $id?>&resimid=<?php echo $rs_getir['id']?>"><span class="glyphicon glyphicon-remove"></span></a></center>
		...
		$(function() {
		  ...
		  $("#test-list").sortable({
		    ...
		    update:function(){
		      ...
		      $.post("etkinlikresimsiralaislem.php",posted,function(e){
