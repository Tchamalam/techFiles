		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="panel panel-default">
					...
					<h3 class="panel-title">Yeni Haber Ekle</h3>
					...
					if(isset($_POST['gonder'])){
						...
						$son_id=mysql_fetch_object(mysql_query("select * from duyurular order by ids desc"));
						$idal=$son_id->id;
						$idal=$idal+1;
						$baslik   = $_POST["basliktr"];
						$public   = $_POST["public"];
						$katid   = $_POST["katid"];
						$sor = mysql_query("SELECT * FROM duyurular WHERE baslik='$baslik'");
						if(mysql_num_rows($sor) > 0){

							echo '<div class="alert alert-danger">'.$baslik.' Adlı Haber Sistemde Bulunmaktadır.</div>';
							...
							if($baslik == ""){
								...
								if($_FILES["dosya"]["size"] > 0){
									...
									$ekle =  mysql_query("INSERT INTO duyurular (id, baslik, baslikseo, katid, resim, yazi, tarih, public, dil) VALUES ('$idal', '$baslik', '$baslikseo', '$katid', '$yeniresimadi', '$yazi', '$tarih', '$public', '$diller->id')");
									}
										echo '<div class="alert alert-success">Yeni Haber Başarıyla Eklendi</div>';
									...
									$ekle2 = mysql_query("INSERT INTO duyurular (id, baslik, baslikseo, katid, yazi, tarih, public, dil) VALUES ('$idal', '$baslik', '$baslikseo', '$katid', '$yazi', '$tarih', '$public', '$diller->id')");
									}
							...
							<div class="tab-pane <?php if($j==1){ echo "active"; } ?> fade in" id="<?php echo $diller2->links?>">
								...
								<fieldset>
									<div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" class="form-control" id="inputEmail" name="baslik<?php echo $diller2->links?>" placeholder="Haber Başlığı">
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-lg-12">
											<button name="gonder" type="submit" class="btn btn-default">Haber Ekle</button>
										</div>
									</div>
