<?php
	...
	$genel = array(
		'tumurunler' 	=> 'TÜM ÜRÜN KATEGORİLERİ',
		'urunkod'		=> 'Ürün Kodu : ', 
		'rafblog' 		=> 'RAFF TEKSTİL BLOG',
		'rafvideo' 		=> 'RAFF TEKSTİL VİDEO',
		'ebulten' 		=> 'E-BÜLTEN KAYIT OL',
		'ebultenyazi'	=> 'Bizden haberdar olmak için e-bültenimize kayıt olun',
		'takip'			=> 'Bizi Takip Edin!',
		'sosyalmedya'	=> 'Sosyal medya hesaplarımızı takip edin.',
		'kayitol'		=> 'KAYIT OL',
		'emailyaz' 		=> "E-posta adresinizi yazınız",
		'ad' 			=> "Adınız",
		'soyad' 		=> "Soyadınız",
